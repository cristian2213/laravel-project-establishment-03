    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            <form action="{{ route('establecimientos.update', $establecimiento->id) }}" method="POST"
                class="col-xs-12 col-md-9 card card-body" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="mt-3 w-100">
                            <img src="/storage/{{ $establecimiento->imagen_principal }}"
                                alt="{{ $establecimiento->nombre }}" class="img-fluid img-thumbnail d-block"
                                width="300px">
                        </div>
                ...
                <fieldset class="border p-4 mb-4 mt-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="direccion" placeholder="Dirreción"
                            value="{{ $establecimiento->direccion }}" name="direccion"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="barrio" placeholder="Dirreción" value="{{ $establecimiento->colonia }}"
                            name="barrio" class="form-control @error('barrio') is-invalid @enderror">
                ...
                <input type="submit" class="btn btn-primary mt-3 d-block" value="Editar Establecimientos">
